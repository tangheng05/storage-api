...
module.exports = {
  ...
  // Thinking costs seconds on a call that returns three integers. Gemini 3 takes
  // a level (MINIMAL/LOW/MEDIUM/HIGH), 2.5 takes a token budget (0 = off) --
  // sending the wrong one is a 400. Empty omits it and lets the model decide.
  SCAN_GEMINI_THINKING: (process.env.SCAN_GEMINI_THINKING || '').trim(),
